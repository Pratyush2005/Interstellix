    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-black/15 backdrop-blur-xl border-b border-cyan-500/10 py-2 md:py-3 lg:py-3">
      <div className="container mx-auto px-4 flex items-center justify-between gap-x-4">
        ...
        <form
          ...
          className="flex items-center bg-black/40 rounded-full px-2 py-1 border border-cyan-500/20"
        >
          <input
            type="text"
            value={searchInput}
            ...
            className="bg-transparent text-white placeholder-cyan-400 outline-none px-2 py-1 w-28 md:w-48 lg:w-64"
          />
